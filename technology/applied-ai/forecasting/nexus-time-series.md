...
把四代理套到「預測台北某區下一季成交量/價」:

1. **事件整理員** 掃新聞/政策,整理出時間軸:如「央行升息半碼」「該區捷運新線通車」「實價登錄新制上路」。
2. **宏觀觀察員** 判定當前體制:升息循環尾端、政策偏緊縮。
3. **微觀追蹤員** 抓區域特殊衝擊:捷運通車帶動該區、但某大型建案集中交屋造成短期供給。
4. **合成員** 把三者 + **過去幾季自己預測的誤差** 一起餵進去,給出帶理由的預測(不只外推曲線,而是「為什麼曲線會這樣動」)。

> 對照傳統 ARIMA/Prophet:它們只看歷史價格曲線,讀不懂「捷運通車」這種事件。**適用情境**=房地產、股票、電商等 **事件驅動波動** 的預測;不適合純技術性、無事件脈絡的訊號。落地關鍵呼應第 4 節:**角色定義 > 模型選擇、把誤差記進 context、任務拆解**。
