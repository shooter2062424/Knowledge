...
- **Why QQ 剩 1**:`nScMXSWz9aE` vgpu(09-05~09-16 已完成 `9uq4FRJ0oEE` 陶哲軒聯名聲明、`6Ly6wZUsESA` Anthropic 威脅情報報告、 `Ea1XvVD7GTY` DeepSeek V4.1-Flash、`98Mz0a1wJag` Voice Spec Loop、 GPT-6 Astra、DHH 16 條並行、RSA-260、AI 原生 SDLC、可塑軟體、Skill Doctor、HN 熱帖、`-XBnFO6FweQ` 刪提示詞、`0AvqP_WRVVM` 刪完之後寫什麼、`zFSWbN7VKB8` Coxon 辭職信、`479-FVtko2c` 29 個邏輯閘玩馬里奧)
- **Caleb 剩 6**(09-14 完成 `7DncQnIjZmA` Navier-Stokes 署名爭議):`noPuRPDiY6k` AGI, are we there yet(09-09 新片,⚠️ 含 Micro Center 業配;09-10 三度嘗試抓自動字幕全數 **HTTP 429**,順延)、`3WbXyUolFA0`、`ZxBRtRjMU88` HBF、`Cx-pVoBR7C0`、`8ji5vURIllM` Why harness is SO expensive、`O1JMZvgFxKE`(09-04 完成 `dGHLg9NfvEo` Fable 5.1 質疑;09-05 完成 `XvmixEXPT3Q` GPT-6 Astra,與 Why QQ 版合併為同一篇)
...
- **白白说大模型 剩 12**(09-16 完成 `MWNuu9m93dk` 多 Agent 資料一致性):`Zez7CMkSZsI`(09-11 新片,職場人專屬選型指南,需 Whisper)、`wt2kiCU6sA0`(09-10 新片,面向普通人的 AI 時代入局指南,需 Whisper)、`dThNVDU64ew`(09-09 新片,需 Whisper)
