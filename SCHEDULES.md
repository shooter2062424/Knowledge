...
- **Why QQ 剩 1**:`nScMXSWz9aE` vgpu(09-05~09-11 已完成 GPT-6 Astra、DHH 16 條並行、RSA-260、AI 原生 SDLC、可塑軟體、Skill Doctor、HN 熱帖、`-XBnFO6FweQ` 刪提示詞、`0AvqP_WRVVM` 刪完之後寫什麼、`zFSWbN7VKB8` Coxon 辭職信)
...
- **YAHA學堂 剩 7**:`zK2TjT17b8U`(09-10 新片,Claude Cowork 加班費對帳示範,無字幕,待補)、`rq4EHbqaaAk` diagram-design skill(09-03 新片,無字幕)、`9leHSMk-9nY`、`H4zIuJ4G1QY`、`ahb8kfsZmIk`、`yrnGrdPZx_U`(以上無字幕)、`Wq1icAZYr4E` Claude 隱藏設定(官方字幕)。09-07 完成 `X2A6fANij9Q` workload creep。
...
- **白白说大模型 新增 2**:`wt2kiCU6sA0`(09-10 新片,面向普通人的 AI 時代入局指南,需 Whisper)、`dThNVDU64ew`(09-09 新片,需 Whisper)
